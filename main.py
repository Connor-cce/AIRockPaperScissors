...
while True:
    imgBG = cv2.imread("resources/BGtemp.png")
    ...
    # imgBG[268:669,815:1199] = imgScaled
    imgBG[234:654,795:1195] = imgScaled

    if stateResult:
        imgBG = cvzone.overlayPNG(imgBG, imgAI, (149, 310))
    
    cv2.putText(imgBG, str(scores[0]), (390, 215), cv2.FONT_HERSHEY_PLAIN, 4, (255, 255, 255), 4)
    cv2.putText(imgBG, str(scores[1]), (1112, 215), cv2.FONT_HERSHEY_PLAIN, 4, (255, 255, 255), 4)
